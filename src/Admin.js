...
import { FaCheck, FaCopy, FaDownload, FaEdit, FaLink, FaLock, FaTrash, FaUpload } from "react-icons/fa";
  ...
  return (
    <WideContainer>
      ...
      <div className="bg-white shadow w-full overflow-hidden sm:rounded-md mt-8">
        ...
        <ul>
          <li className=" w-full border-t border-gray-200 p-4
                  ...
                  <div className="w-24">
                    <span
                      className={"px-2 inline-flex text-xs leading-5 font-semibold rounded-full " +
                        ...
                        (u.role == "admin" && " bg-green-100 text-bg-green-800 ")
                      }>
                      {u.role}
                    </span>
                  ...
                  <div className="flex flex-row">
                    {u.role != "admin" &&
                      <button
                        ...
                        <FaTrash size={10} className="text-gray-500 mr-1" /> Delete user
                    </button>
                    }
                    <button
                      onClick={() => {
                      ...
                      className="mb-4 mr-4 focus:outline-none rounded-3xl flex flex-row items-center justify-center text-xs py-1 px-4 bg-blue-50 hover:bg-gray-200 transition duration-150">
                      <FaEdit size={10} className="text-gray-500 mr-1" /> Change password
                    </button>
                  </div>
                </div>
              </li>
